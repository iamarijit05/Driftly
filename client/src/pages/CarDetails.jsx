      ...
      <div className='px-6 md:px-16 lg:px-24 xl:px-32 mt-16'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12'>
          ...
          <div className='lg:col-span-2'>
            <img src={car.image} alt="" className= 'w-full h-auto wd:max-h-100 object-cover rounded-xl mb-6 shadow-md' />
            <div className='space-y-6'>
              <div>
                <h1 className = 'text-3xl font-bold'> {car.brand} {car.model} </h1>
                <p className='text-gray-500 text-lg' >{car.category} . {car.year} </p>
              </div>
              <hr className='grid grid-cols-2 sm:grid-cols-4 gap-4' />
          ...
          <form onSubmit={handleSubmit} className='shadow-lg h-max sticky top-18 rounded-xl p-6 space-y-6 text-gray-500'>
            ...
            <p className='text-center text-sm'>No Credit / Debit Card required to reserve</p>
          </form>
        </div>
      </div>
    </div>
