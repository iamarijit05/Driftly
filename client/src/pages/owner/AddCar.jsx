...
const AddCar = () => {
  ...
  return (
    <div className='px-4 py-10 md:px-10 flex-1'>
      <Title title='Add New Car' subTitle='Fill in details to list a new car for booking, including price, availability and car specifications'/>
      ...
      <form onSubmit={onSubmitHandler} className='flex flex-col gap-5 text-gray-500 text-sm mt-6 max-w-xl'>
        ...
        <div className='grid grid-cols-1 md: grid-cols-2 gap-6'>
          <div className='flex flex-col w-full'>
            <label>Brand</label>
            <input type='text' placeholder='e.g. BMW, Mercedes, Audi..' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.brand} onChange={e => setCar({
          ...
          <div className='flex flex-col w-full'>
            <label>Model</label>
            <input type='text' placeholder='e.g. X7, Maybach GLS' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.model} onChange={e => setCar({
        ...
        <div className='grid grid-cols-1 sm: grid-cols-2 md: grid-cols-3 gap-6'>
            ...
            <div className='flex flex-col w-full'>
              ...
              <input type='number' placeholder='5000' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.pricePerDay} onChange={e => setCar({...car, pricePerDay: e.target.value})}/>
            </div>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md: grid-cols-3 gap-6'>
            ...
            <div className='flex flex-col w-full'>
              ...
              <input type='number'  required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.seating_capacity} onChange={e => setCar({
